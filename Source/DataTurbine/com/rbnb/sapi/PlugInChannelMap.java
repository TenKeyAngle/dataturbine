...
public class PlugInChannelMap extends ChannelMap
{
	...
	/**
	  ...
	  *  of frames, in which case the time values represent integer
	  *  frame indices.  (Otherwise the request represents time in
	  *  seconds.)
	  * <p>
     *
     * @author WHF
     ...
     * @since V2.0
     * @version 01/25/2002
	 * @deprecated Support for frame requests is to be removed before
	 *		the next release.
     */
	...
	final void processPlugInRequest(Object result) throws Exception
	{
		...
		if (result!=null)
		{
			...
			{ // wants registration
				...
				raiseForRegistrationFlag();
			}
			else req=(DataRequest) result;
...
if (debugFlag) System.err.println(
	...
	private void raiseForRegistrationFlag() { forRegistrationFlag=true; }

/////////////////// Private Data: ///////////////////////
	private double pluginStart, pluginDuration, repeatInterval=1.0;
	private boolean pluginTimeMode, forRegistrationFlag=false;
